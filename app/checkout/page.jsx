...
export default function CheckoutPage() {
  ...
  const discount = 0; // 目前不套用折扣
  const total = Math.max(0, subTotal + shipping - discount);

  if (!items.length) {
    return (
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-4">購物清單確認</h1>
        <p className="text-slate-600">購物車內尚無商品。</p>
        ...
        <div className="bg-white border rounded-xl overflow-hidden">
          ...
          {items.map((it) => (
            ...
            >
              ...
              {/* 單價（桌面版顯示） */}
              <div className="md:text-right text-slate-800 hidden md:block">
